use crate::types::{GpuSelection, ScalingMode, ThemeProvider};
...
pub struct VideoConfig {
    ...
    #[serde(default)]
    pub preferred_gpu: GpuSelection,
...
impl Default for VideoConfig {
    fn default() -> Self {
        Self {
            ...
            preferred_gpu: GpuSelection::Auto,
...
mod tests {
    ...
    fn test_roundtrip_serialize() {
        ...
        assert_eq!(parsed.wallpaper.mode, cfg.wallpaper.mode);
    }
}
